...
def test():
    ...
    time_dif = get_time_dif(start_time)
    print("Time usage:", time_dif)
    return msg.format(loss_test, acc_test)


def log_and_clean(test_result, para):
    ...
    f1.close()
    f2.close()
    del_file('checkpoints')
    del_file('tensorboard')
